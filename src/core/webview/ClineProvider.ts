	...
	implements vscode.WebviewViewProvider, TelemetryPropertiesProvider
{
	...
	*/
		...
		*/
        ...
        <html lang="en">
          <head>
            ...
            <meta http-equiv="Content-Security-Policy" content="default-src 'none'; font-src ${webview.cspSource} data:; style-src ${webview.cspSource} 'unsafe-inline'; img-src ${webview.cspSource} https://storage.googleapis.com https://img.clerk.com data:; media-src ${webview.cspSource}; script-src ${webview.cspSource} 'wasm-unsafe-eval' 'nonce-${nonce}' https://*.posthog.com https://*.i.posthog.com https://*.assets.i.posthog.com 'strict-dynamic'; connect-src ${webview.cspSource} https://openrouter.ai https://api.requesty.ai https://*.posthog.com https://*.i.posthog.com https://*.assets.i.posthog.com;"/>
            <link rel="stylesheet" type="text/css" href="${stylesUri}">
			<link href="${codiconsUri}" rel="stylesheet" />
			<script nonce="${nonce}">
				window.IMAGES_BASE_URI = "${imagesUri}"
	...
	async getStateToPostToWebview() {
		...
		const telemetryHost = process.env.POSTHOG_HOST || "https://us.i.posthog.com"
