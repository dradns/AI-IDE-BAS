...
- **Environment Setup**: Launches VS Code with AI IDE BAS extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and AI IDE BAS extension
