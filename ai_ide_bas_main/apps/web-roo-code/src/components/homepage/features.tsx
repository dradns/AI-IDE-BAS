...
export const features: Feature[] = [
	{
		...
		description:
			"AI IDE BAS puts a team of agentic AI assistants directly in your editor, with the power to plan, write, and fix code across multiple files.",
		size: "large",
	},
	{
		...
		description:
			"From coding to debugging to architecture, AI IDE BAS has a mode for every dev scenario—just switch on the fly.",
		size: "small",
	},
	{
		...
		description:
			"AI IDE BAS reads your entire codebase, preserving valid code through diff-based edits for seamless multi-file refactors.",
		size: "small",
	},
	{
		...
		description:
			"Bring your own model or use local AI—no vendor lock-in. AI IDE BAS is free, open, and adaptable to your needs.",
		size: "large",
	},
	{
		...
		description:
			"Approve or deny commands as needed. AI IDE BAS automates your dev workflow while keeping oversight firmly in your hands.",
		size: "small",
	},
	{
		...
		description:
			"Create or tweak modes, define usage rules, and shape AI IDE BAS’s behavior precisely—your code, your way.",
		size: "small",
	},
	{
		...
		description:
			"Seamlessly test and verify your web app directly from VS Code—AI IDE BAS can open a browser, run checks, and more.",
		size: "small",
	},
]
