...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping AI IDE BAS's enterprise solution."
			: "Fill out the form below to see AI IDE BAS's enterprise capabilities in action."
