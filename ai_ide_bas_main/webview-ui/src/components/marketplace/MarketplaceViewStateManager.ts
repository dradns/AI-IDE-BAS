 ...
 *
 * This class manages the state for the marketplace view in the AI IDE BAS extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the AI IDE BAS extensions interface
