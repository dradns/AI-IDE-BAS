...
_Что изменилось:_ При первом входе через OAuth (Google) система автоматически создает аккаунт и зачисляет
...
**2️⃣ 🛠 Улучшена роль Архитектора** _Что изменилось:_ Добавлена возможность генерации:

1. Диаграмм С4 в PlantUML (Контекстная диаграмма (Context) и Диаграмма контейнеров (Containers))

2. Предварительной оценки временной стоимости решения (исходя из указанного размера команды)

3. Предварительного расчета финансовой стоимость решени**я**

**3️⃣ 📝 Экспорт артефактов в PDF** _Что изменилось:_ Появилась кнопка экспорта готовых артефактов в PDF.
💡_Как это работает:_ После генерации артефакта его можно сохранить в PDF с сохранением форматирования
🎯 _Зачем это нужно: Позволяет поделиться результатами со стейкхолдерами в распространенном формате._
